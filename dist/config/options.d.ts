...
export interface options {
    ...
    /**
     * folder directory tokens, just inside the whatsapp folder, example:  { mkdirFolderToken: '/node_modules', } //will save the tokens folder in the node_modules directory
     * @default 'null'
     */
    ...
    /**
     * Automatically closes the whatsapp only when scanning the QR code (default 60000 miliseconds, if you want to turn it off, assign 0 or false)
     * @default 60000
     */
    autoClose?: number;
    /**
