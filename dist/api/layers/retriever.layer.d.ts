...
import { WhatsappProfile } from 'whatsapp-lp/dist/api/model';
import { SenderLayer } from 'whatsapp-lp/dist/api/layers/sender.layer';
export declare class RetrieverLayer extends SenderLayer {
   ...
   */
    getAllMessagesDate(chatId: string, type: string, idateStart: string, time: string, limit: number): Promise<import("whatsapp-lp/dist/api/model").Message[]>;
     ...
     */
    getBlockList(): Promise<import("whatsapp-lp/dist/api/model").Contact[]>;
    /**
     * Retrieves all chats
     * @returns array of [Chat]
     */
    getAllChats(): Promise<import("whatsapp-lp/dist/api/model").Chat[] | object[]>;
    /**
     * Retrieves all chats new messages
     * @returns array of [Chat]
     */
    getAllChatsNewMsg(): Promise<import("whatsapp-lp/dist/api/model").Chat[]>;
    /**
     ...
     * @returns array of [Chat]
     */
    getAllChatsWithMessages(withNewMessageOnly?: boolean): Promise<import("whatsapp-lp/dist/api/model").Chat[]>;
    /**
     * Retrieve all contact new messages
     * @returns array of groups
     */
    getChatContactNewMsg(): Promise<import("whatsapp-lp/dist/api/model").Chat[]>;
    /**
     * Retrieves contact detail object of given contact id
     * @param contactId
     * @returns contact detial as promise
     */
    getContact(contactId: string): Promise<import("whatsapp-lp/dist/api/model").Contact>;
    /**
     * Retrieves all contacts
     * @returns array of [Contact]
     */
    getAllContacts(): Promise<import("whatsapp-lp/dist/api/model").Contact[]>;
    /**
     ...
     * @returns contact detial as promise
     */
    getChatById(contactId: string): Promise<import("whatsapp-lp/dist/api/model").Chat>;
    /**
     * Retrieves chat object of given contact id
     * @param contactId
     * @returns contact detial as promise
     * @deprecated
     */
    getChat(contactId: string): Promise<import("whatsapp-lp/dist/api/model").Chat>;
    /**
     ...
     * @deprecated
     */
    loadEarlierMessages(contactId: string): Promise<import("whatsapp-lp/dist/api/model").Message[]>;
    /**
     * Retrieves status of given contact
     * @param contactId
     */
    getStatus(contactId: string): Promise<import("whatsapp-lp/dist/api/model").ContactStatus>;
    /**
     ...
     * @returns any
     */
    getAllMessagesInChat(chatId: string, includeMe: boolean, includeNotifications: boolean): Promise<import("whatsapp-lp/dist/api/model").Message[]>;
    /**
     ...
     * @returns any
     */
    loadAndGetAllMessagesInChat(chatId: string, includeMe?: boolean, includeNotifications?: boolean): Promise<import("whatsapp-lp/dist/api/model").Message[]>;
    /**
