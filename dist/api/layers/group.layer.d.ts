...
import { RetrieverLayer } from 'whatsapp-lp/dist/api/layers/retriever.layer';
import { GroupSettings } from 'whatsapp-lp/dist/api/model/enum';
export declare class GroupLayer extends RetrieverLayer {
     ...
     * @returns array of groups
     */
    getChatGroupNewMsg(): Promise<import("whatsapp-lp/dist/api/model").Chat[]>;
    /**
     ...
     */
    createGroup(groupName: string, contacts: string | string[]): Promise<import("whatsapp-lp/dist/api/model").GroupCreation>;
    /**
