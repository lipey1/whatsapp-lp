...
import { Ack, Chat, LiveLocation, Message, ParticipantEvent, PicTumb, ChatStatus } from 'whatsapp-lp/dist/api/model';
import { SocketState, SocketStream } from 'whatsapp-lp/dist/api/model/enum';
import { InterfaceChangeMode } from 'whatsapp-lp/dist/api/model';
import { InterfaceMode } from 'whatsapp-lp/dist/api/model/enum/interface-mode';
import { InterfaceState } from 'whatsapp-lp/dist/api/model/enum/interface-state';
import { ProfileLayer } from 'whatsapp-lp/dist/api/layers/profile.layer';
declare global {
    interface Window {
        onMessage: any;
        onAnyMessage: any;
